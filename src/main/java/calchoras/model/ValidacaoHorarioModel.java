...
public class ValidacaoHorarioModel {
    ...
    public static boolean isHorarioValido(String horario) {
        return horario.matches(ValidacaoHorarioModel.getRegex()) || horario.matches(ValidacaoHorarioModel.getRegex1());
    }

    public static String formatarHorario(String horario){
        if(horario.matches(ValidacaoHorarioModel.getRegex())){
