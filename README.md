...
🚀 Funcionalidades
Gestão de Cadastros: Registro completo de funcionários e empresas.
...
Cálculos Automáticos: Processamento imediato de horas extras e horas negativas com base na jornada configurada.

Relatórios: Geração de resumos de horas para conferência e gestão.
